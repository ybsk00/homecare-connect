  ...
  return (
    <section id="agents" ref={sectionRef} className="relative overflow-hidden bg-primary py-20 lg:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-8">
        ...
        >
          <h2 className="text-3xl font-extrabold tracking-tight text-white lg:text-4xl font-headline">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {agents.map((agent, i) => (
            <div
              key={agent.title}
              className={`rounded-lg bg-white/10 p-8 backdrop-blur transition-all duration-700 ease-out ${
            ...
            >
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="mt-3 text-xl font-bold text-white font-headline">{agent.title}</h3>
                </div>
        ...
        >
          <Link
            href="/login"
            className="inline-flex items-center gap-2 rounded-lg bg-white px-8 py-4 text-base font-bold text-primary shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5"
          >
            AI 에이전트 체험하기

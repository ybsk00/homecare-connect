  ...
  return (
    ...
    >
      ...
      <View style={{ paddingHorizontal: Spacing.xl, marginBottom: Spacing.xl }}>
        <TouchableOpacity activeOpacity={0.85} onPress={() => Alert.alert('준비 중', 'AI 어시스턴트가 곧 출시됩니다')} style={styles.agentCard}>
          <LinearGradient
            colors={[Colors.secondary, '#004D47']}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}
          ...
          >
            <View style={styles.agentCardLeft}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.agentCardTitle}>AI 운영 어시스턴트</Text>
                <Text style={styles.agentCardDesc}>환자 현황, 직원 배정, 일정 관리를 AI가 도와드립니다</Text>
              </View>
            </View>
